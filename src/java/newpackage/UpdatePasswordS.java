        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(id);
             ...
             //STEP 1 : REGISTERING OF THE REQUIRED DRIVER WITH THE JAVA PROGRAM
                ...
                String q = "update student set password=? where id=?";
                ...
                response.sendRedirect("http://localhost:8080/MajorProject/StudentPages/passsuccessS.html");
                ost.close();
                oconn.close();
            out.println("</body>");
            out.println("</html>");
            ...
            Logger.getLogger(UpdatePasswordS.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
