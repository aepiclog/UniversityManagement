    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(id);
             ...
             ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM student where id=?");
            ...
            { out.println(id);
              ...
              String  year = ors.getString("year");
              ...
              response.sendRedirect("http://localhost:8080/MajorProject/AdminPages/EditStudent.jsp");
            }
            else{
